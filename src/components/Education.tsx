...
import { IEducationCredential, IEducationCredentials } from "../util/constants";
        ...
        return <>
            <div className="timeline-card timeline-card-success card shadow-sm">
                <div className="card-body">
                    <div className="h5 mb-1">{this.props.Name} <span className="text-muted h6">from {this.props.Organization}</span></div>
                    <div className="text-muted text-small mb-2">{this.props.FromYear} - {this.props.ToYear}</div>
